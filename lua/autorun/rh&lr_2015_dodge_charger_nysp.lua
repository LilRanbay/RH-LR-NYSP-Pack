...
local VehicleName = "2015 Dodge Charger NYSP [RH&LR]"
...
EMV.Auto = {
	...
	},
	{
		...
		Ang = Angle( 90, -90, 0 ),
		Color1 = "RED",
		Phase = "CHARGER15PBSIDEB"
	},
	-- FLASHERS --
	{                 
		ID = "NYNYSP Charger15 Flashers",                             
		Scale = 1,
		Pos = Vector( 0, 0, 0 ),  
		Ang = Angle( 0, 0, 0 ),      
	},
...
EMV.Selections = {
	...
	},
	{
		...
		Options = {
			...
			{ Name = "Setup #2", Props = {27,28,29,30} },
		},
	},
}
...
list.Set( "Vehicles", "2015_dodge_charger_nysp_[rh&lr]_48612855", V )
