...
local VehicleName = "2006 Dodge Charger NYSP Slicktop [RH&LR]"

local EMV = {}

EMV.Siren = "lr_w_295"
EMV.Skin = "rh&lr/nynysp/charger06_patrol_black"
EMV.Color = Color(255,255,255)

EMV.Liveries = {
	["NYSP"] = { 
		["NYSP Patrol Black"] = "rh&lr/nynysp/charger06_patrol_black",
...
list.Set( "Vehicles", "2006_dodge_charger_nysp_slicktop_[rh&lr]_48612855", V )
